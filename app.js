...
var _user$project$BST$num = function (tree) {
	...
	if (_p0.ctor === 'Leaf') {
		...
		return (_user$project$BST$num(_p0._0) + 1) + _user$project$BST$num(_p0._2);
	}
};
var _user$project$BST$leftNum = function (tree) {
	var _p1 = tree;
	if (_p1.ctor === 'Leaf') {
		return 0;
	} else {
		return _user$project$BST$num(_p1._0);
	}
};
var _user$project$BST$rightNum = function (tree) {
	var _p2 = tree;
	if (_p2.ctor === 'Leaf') {
		return 0;
	} else {
		return _user$project$BST$num(_p2._2);
	}
};
var _user$project$BST$fold = F3(
...
var _user$project$BST$sum = function (tree) {
	return A3(
		_user$project$BST$fold,
		F2(
			function (x, y) {
...
var _user$project$BST$product = function (tree) {
	return A3(
		_user$project$BST$fold,
		F2(
			function (x, y) {
...
var _user$project$BST$toList = function (tree) {
	return _elm_lang$core$List$reverse(
		A3(
			_user$project$BST$fold,
			F2(
...
var _user$project$BST$depth = function (tree) {
	var _p4 = tree;
	if (_p4.ctor === 'Leaf') {
		return 0;
	} else {
		return 1 + A2(
			...
			_user$project$BST$depth(_p4._0),
...
var _user$project$BST$empty = _user$project$BST$Leaf;
var _user$project$BST$singleton = function (v) {
	return A3(_user$project$BST$Node, _user$project$BST$empty, v, _user$project$BST$empty);
};
